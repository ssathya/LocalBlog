namespace ModernBlog.AuthenticationStateSync;
...
public class PersistingRevalidatingAuthenticationStateProvider : RevalidatingServerAuthenticationStateProvider
{
    ...
    private async Task OnPersistingAsync()
    {
        ...
        {
            var userId = principal.FindFirst(_options.ClaimsIdentity.UserIdClaimType)?.Value ?? "Undermined";
            var name = principal.FindFirst("name")?.Value ?? "Undermined";
            var email = principal.FindFirst("email")?.Value ?? "Undermined";
